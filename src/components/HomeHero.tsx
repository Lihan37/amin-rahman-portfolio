      ...
      <div className="grid items-center gap-10 md:grid-cols-[1.05fr_0.95fr] md:grid-rows-[auto_auto] animate-fade-up">
        ...
        <div className="order-2 relative md:col-start-2 md:row-start-1 md:row-span-2">
          ...
          <div className="relative h-[420px] w-full sm:h-90 md:h-105">
            ...
            <div className="absolute left-1/2 top-[190px] z-30 h-[200px] w-[160px] -translate-x-1/2 overflow-hidden rounded-[26px] border border-white/80 bg-white/95 shadow-[0_20px_55px_rgba(16,35,21,0.22)] ring-1 ring-[color:var(--leaf)]/18 transform-gpu sm:top-1/2 sm:-translate-y-1/2 sm:h-[235px] sm:w-45 md:h-[250px] md:w-[190px]">
              <img
            ...
            <div className="absolute right-3 top-6 z-20 h-[190px] w-[150px] rotate-6 overflow-hidden rounded-[24px] border border-white/75 bg-white/90 shadow-[0_18px_45px_rgba(16,35,21,0.18)] ring-1 ring-[color:var(--leaf)]/15 sm:bottom-3 sm:right-3 sm:top-auto sm:h-[215px] sm:w-[165px] md:bottom-4 md:right-2 md:h-[255px] md:w-[195px]">
              <img
